        ...
        const columnDefs: ColumnDefinition[] = [
            {
                ...
                cellRenderer: function (params: any) {
                    ...
                    return (
                        ...
                        " " +
                        (acqEquip.manufacturerModel.magneticField
                            ? acqEquip.manufacturerModel.magneticField + "T"
                            : "") +
                        " (" +
                        DatasetModalityType.getLabel(
                            acqEquip.manufacturerModel.datasetModalityType,
                        ) +
                        ")" +
                        " " +
            ...
            },
            {
                ...
                field: "manufacturerModel.manufacturer.name",
                route: (acqEquip: AcquisitionEquipment) =>
                    "/manufacturer/details/" +
                    acqEquip.manufacturerModel.manufacturer.id,
            },
            {
                headerName: "Modality",
                field: "manufacturerModel.datasetModalityType",
                cellRenderer: function (params: any) {
                    const mod = DatasetModalityType.all().find(
                        (dsMod) =>
                            dsMod.toString() ==
                            params.data.manufacturerModel.datasetModalityType,
                    );
                    if (mod) return DatasetModalityType.getLabel(mod);
                },
            },
            {
                headerName: "Manufacturer model name",
                field: "manufacturerModel.name",
                route: (acqEquip: AcquisitionEquipment) =>
                    "/manufacturer-model/details/" +
                    acqEquip.manufacturerModel.id,
            },
            {
            ...
            },
            {
                ...
                field: "center.name",
                route: (acqEquip: AcquisitionEquipment) =>
                    "/center/details/" + acqEquip.center.id,
            },
        ];
