    ...
    buildForm(): UntypedFormGroup {
        return this.formBuilder.group({
            name: [
                this.center.name,
                [
                    ShanoirValidators.required,
                    ShanoirValidators.minLength(2),
                    ShanoirValidators.maxLength(200),
                    this.registerOnSubmitValidator("unique", "name"),
                ],
            ],
            street: [this.center.street],
            postalCode: [
                this.center.postalCode,
                [Validators.pattern(/^[0-9]*$/)],
            ],
            city: [this.center.city],
            country: [this.center.country],
            phoneNumber: [
                this.center.phoneNumber,
                ShanoirValidators.isPhoneNumber(),
            ],
