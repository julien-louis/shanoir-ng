...
export class BloodGasDataFormComponent extends EntityComponent<BloodGasDataFile> {
    ...
    get bloodGasData(): BloodGasDataFile {
        return this.entity;
    }
    set bloodGasData(bloodGasData: BloodGasDataFile) {
        this.entity = bloodGasData;
    }
        ...
        return this.extradatasService
            ...
            .then((bloodGasData) => {
                ...
                this.consoleService.log(
                    "info",
                    "New preclinical bloodgasdata successfully saved with n° " +
                        bloodGasData.id,
                );
                return bloodGasData;
            });
