...
export class ContrastAgentsListComponent extends BrowserPaginEntityListComponent<ContrastAgent> {
    ...
    constructor(private contrastAgentsService: ContrastAgentService) {
    ...
    getColumnDefs(): ColumnDefinition[] {
        return [
            ...
            {
                headerName: "Manufactured Name",
                field: "manufacturedName",
                type: "string",
            },
            {
            ...
            {
                headerName: "Injection interval",
                field: "injectionInterval",
                type: "string",
