...
export class ImportService {
    ...
    uploadFile(formData: FormData): Observable<HttpEvent<ImportJob>> {
        return this.http.post<ImportJob>(
            AppUtils.BACKEND_API_UPLOAD_DICOM_URL,
            formData,
    ...
    uploadFileMultiple(
        formData: FormData,
        job: ImportJob,
    ): Observable<HttpEvent<ImportJob>> {
        return this.http.post<ImportJob>(
            AppUtils.BACKEND_API_UPLOAD_MUTIPLE_DICOM_URL +
                "study/" +
                job.studyId +
                "/studyName/" +
                job.studyName +
    ...
    uploadEegFile(formData: FormData): Observable<HttpEvent<EegImportJob>> {
        return this.http.post<EegImportJob>(
            AppUtils.BACKEND_API_UPLOAD_EEG_URL,
            formData,
            { reportProgress: true, observe: "events" },
        );
    }
    ...
    async startProcessedDatasetImportJob(
