...
export class DatasetAcquisitionListComponent extends EntityListComponent<DatasetAcquisition> {
    ...
    constructor(private datasetAcquisitionService: DatasetAcquisitionService) {
    ...
    getColumnDefs(): ColumnDefinition[] {
        const colDef: ColumnDefinition[] = [
            ...
            },
            {
                ...
                orderBy: ["examination.study.name"],
                route: (dsAcq: DatasetAcquisition) =>
                    "/study/details/" + dsAcq.examination.study.id,
            },
            {
                headerName: "Subject",
                field: "examination.subject.name",
                defaultField: "examination.subject.id",
                orderBy: ["examination.subject.name"],
                route: (dsAcq: DatasetAcquisition) =>
                    "/subject/details/" + dsAcq.examination.subject.id,
            },
            {
            ...
            },
            {
                ...
                orderBy: ["examination.centerId"],
                route: (dsAcq: DatasetAcquisition) =>
                    dsAcq.acquisitionEquipment &&
            ...
            {
                headerName: "StudyCard",
                field: "studyCard.name",
                route: (dsAcq: DatasetAcquisition) =>
                    dsAcq.studyCard
                        ? "/study-card/details/" + dsAcq.studyCard.id
                        : null,
            },
        ];
        return colDef;
