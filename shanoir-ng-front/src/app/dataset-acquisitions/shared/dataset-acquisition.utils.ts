...
export abstract class DatasetAcquisitionUtils {
    static getNewDAInstance(type: string): DatasetAcquisition {
        switch (type) {
            case "Mr":
                return new MrDatasetAcquisition();
            case "Pet":
                return new PetDatasetAcquisition();
            case "Ct":
                return new CtDatasetAcquisition();
            case "Xa":
                return new XaDatasetAcquisition();
            case "Generic":
                return new GenericDatasetAcquisition();
            case "BIDS":
                return new BidsDatasetAcquisition();
            case "Eeg":
                return new EegDatasetAcquisition();
            default:
                throw new Error(
                    'Received dataset acquisition has no valid "type" property',
                );
        }
    }
}
