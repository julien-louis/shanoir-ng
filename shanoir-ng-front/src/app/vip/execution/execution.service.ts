...
export class ExecutionService {
    ...
    public createExecution(execution: ExecutionCandidateDto): Promise<IdName> {
        if (execution === null || execution === undefined) {
            throw new Error(
                "Required parameter execution was null or undefined when calling createExecution.",
            );
        }
        return firstValueFrom(
            this.httpClient.post<IdName>(`${this.executionUrl}/`, execution),
        );
    }
    ...
    public getStderr(executionIdentifier: string): Observable<string> {
        if (executionIdentifier === null || executionIdentifier === undefined) {
            throw new Error(
                "Required parameter executionIdentifier was null or undefined when calling getStderr.",
            );
        }
        return this.httpClient.get(
            `${this.executionUrl}/${executionIdentifier}/stderr`,
            { responseType: "text" },
        );
    }
    ...
    public getStdout(executionIdentifier: string): Observable<string> {
        if (executionIdentifier === null || executionIdentifier === undefined) {
            throw new Error(
                "Required parameter executionIdentifier was null or undefined when calling getStdout.",
            );
        }
        return this.httpClient.get(
            `${this.executionUrl}/${executionIdentifier}/stdout`,
            { responseType: "text" },
        );
    }
}
