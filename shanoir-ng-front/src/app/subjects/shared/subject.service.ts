...
export class SubjectService extends EntityService<Subject> {
    ...
    constructor(
        ...
        protected subjectDTOService: SubjectDTOService,
    ) {
        super(http);
    }
    ...
    getAllSubjectsNames(): Promise<IdName[]> {
        return firstValueFrom(
            this.http.get<IdName[]>(AppUtils.BACKEND_API_SUBJECT_NAMES_URL),
        );
    }
    ...
    getSubjectsNames(subjectIds: Set<number>): Promise<IdName[]> {
        ...
        return firstValueFrom(
            this.http.post<IdName[]>(
                AppUtils.BACKEND_API_SUBJECT_NAMES_URL,
                formData,
            ),
        );
    }
    ...
    getClinicalSubjects(): Promise<Subject[]> {
        return firstValueFrom(
            this.http.get<Subject[]>(
                AppUtils.BACKEND_API_SUBJECT_URL + "?preclinical=false",
            ),
        );
    }
    ...
    getPreclinicalSubjects(): Promise<Subject[]> {
        return firstValueFrom(
            this.http.get<Subject[]>(
                AppUtils.BACKEND_API_SUBJECT_URL + "?clinical=false",
            ),
        );
    }
    ...
    getPage(pageable: Pageable, name: string): Promise<Page<Subject>> {
        ...
        return firstValueFrom(
            this.http.get<Page<Subject>>(
                AppUtils.BACKEND_API_SUBJECT_FILTER_URL,
                params,
            ),
        );
    }
