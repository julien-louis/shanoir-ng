...
export class SubjectService extends EntityService<Subject> {
    ...
    getAllSubjectsNames(): Promise<IdName[]> {
        return this.http
            .get<IdName[]>(AppUtils.BACKEND_API_SUBJECT_NAMES_URL)
            .toPromise();
    }
    ...
    getSubjectsNames(subjectIds: Set<number>): Promise<IdName[]> {
        ...
        return this.http
            .post<IdName[]>(AppUtils.BACKEND_API_SUBJECT_NAMES_URL, formData)
            .toPromise();
    }
    ...
    getPage(pageable: Pageable, name: string): Promise<Page<Subject>> {
        ...
        return this.http
            .get<Page<Subject>>(AppUtils.BACKEND_API_SUBJECT_FILTER_URL, params)
            .toPromise();
    }
